...
extension Song {
    static var mockSong: Song {
        Song(
            ...
            previewUrl: URL(string: "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview/test.m4a"),
    ...
    static var mockedAlbumData: [Song] {
        ...
        return [
            Song(
                ...
                previewUrl: URL(string: "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview/test1.m4a"),
            ...
            Song(
                ...
                previewUrl: URL(string: "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview/test2.m4a"),
